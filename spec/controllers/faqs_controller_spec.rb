  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested faq" do
        ...
        Faq.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => faq.to_param, :faq => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the faq as @faq" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Faq.any_instance.stub(:save).and_return(false)
        put :update, {:id => faq.to_param, :faq => {}}, valid_session
        assigns(:faq).should eq(faq)
      end
